...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-[12px] border border-[#D8C3A5]/30 bg-card text-card-foreground shadow-md transition-all duration-300",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "text-2xl font-semibold leading-relaxed tracking-wide text-primary",
      className
    )}
    {...props}
  />
