      ...
      <Card className="overflow-hidden shadow-card rounded-[12px] fade-in-card">
        <Tabs defaultValue="spiritual">
          <TabsList className="flex w-full border-b border-gray-200 bg-transparent p-0 rounded-none">
            ...
            >
              <svg className="w-4 h-4 mr-2 hover-scale" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="5"/><path d="M12 1v2M12 21v2M4.2 4.2l1.4 1.4M18.4 18.4l1.4 1.4M1 12h2M21 12h2M4.2 19.8l1.4-1.4M18.4 5.6l1.4-1.4"/></svg>
            ...
            <TabsTrigger 
              ...
              className="flex-1 py-3 px-4 font-medium data-[state=active]:tab-active data-[state=active]:shadow-none rounded-none"
            >
              <svg className="w-4 h-4 mr-2 hover-scale" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/><line x1="9" y1="9" x2="9.01" y2="9"/><line x1="15" y1="9" x2="15.01" y2="9"/></svg>
